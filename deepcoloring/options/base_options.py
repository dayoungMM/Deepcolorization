...
from deepcoloring import models
import torch
from deepcoloring import data
...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--checkpoints_dir', type=str, default='./deepcoloring/checkpoints', help='models are saved here')
    ...
    def gather_options(self):
        ...
        print("데이터셋 : ", dataset_option_setter )
        print("안녕 : ", self.isTrain)
