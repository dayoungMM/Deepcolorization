...
from deepcoloring.data.base_data_loader import BaseDataLoader
from deepcoloring.data.base_dataset import BaseDataset
...
def find_dataset_using_name(dataset_name):
    ...
    dataset_filename = "deepcoloring.data." + dataset_name + "_dataset"
    datasetlib = importlib.import_module(dataset_filename)


    # model_filename = "deepcoloring.models." + model_name + "_model"
